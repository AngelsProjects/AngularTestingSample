...
## Angular Testing Sample

This repository contains the code of the [Angular Testing Sample](https://angular-university.io/course/angular-testing-sample).

This sample repository is updated to Angular v10, and there is a  package-lock.json file available, for avoiding semantic versioning installation issues.

![Angular Testing Sample](https://s3-us-west-1.amazonaws.com/angular-university/course-images/angular-testing-small.png)
...
We can install the master branch using the following commands:
    ...
    git clone https://github.com/angular-university/angular-testing-sample.git
    
This repository is made of several separate npm modules, that are installable separately. For example, to run the au-input module, we can do the following:
    
    cd angular-testing-sample
    npm install
